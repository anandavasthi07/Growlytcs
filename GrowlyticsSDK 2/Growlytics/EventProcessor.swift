...
class EventProcessor: NSObject {
    ...
    func onActivityCreated() {
        self.serialQueue.async {
            ...
            //                    // Track notification clicked event
            //                    trackNotificationClicked(notif, null);
            //                }
            //
...
//            event.name = Constants.EVENT_IDENTIFY_CUSTOMER
//            event.clientCustomerId = uniqueCustomerId
//            event.eventType = .identifyCustomer
...
//                    var attributeInfo = [String: Any]()
//                    attributeInfo["name"] = key
//                    attributeInfo["value"] = value
//                    attributeInfo["type"] = String(describing: type(of: value)).lowercased()
//                    info[key] = attributeInfo
//                }
//                event.info = info
//
//                // Add event to queue.
